...
@injectable()
export class OmlDiagramManager extends DiagramManagerImpl {
    ...
    constructor(@inject(OmlLanguageClientContribution) languageClientContribution: LanguageClientContribution,
